    ...
    <section className="register">
      ...
      <form action="#" onSubmit={onSubmit} className="form">
        <div className="form__input-container">
          ...
          <input
            id="username" type="text" name="username" className="form__input form__input_data_username" minLength="2" maxLength="30" required autoComplete="off" />
        ...
        <button
          ...
          name="button2">
          <Link className="form__movies" to="/signin">Зарегистрироваться</Link>
